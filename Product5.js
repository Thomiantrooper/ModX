    ...
    <div className="product-container">
      <div className="helmets-container">
        <div className="helmet-item" onClick={() => handleSelectHelmet(1)}>
          <img src="/images/axor1.jpeg" alt="Helmet 10" className={selectedHelmet === 1 ? 'selected' : ''} />
        </div>
        <div className="helmet-item" onClick={() => handleSelectHelmet(2)}>
          <img src="/images/axor2.jpeg" alt="Helmet 11" className={selectedHelmet === 2 ? 'selected' : ''} />
        </div>
        <div className="helmet-item" onClick={() => handleSelectHelmet(3)}>
          <img src="/images/axor3.jpeg" alt="Helmet 12" className={selectedHelmet === 3 ? 'selected' : ''} />
        </div>
      </div>
      <div className="description-container">
        <div className="description-content">
          <h2>Details:</h2>
          <p>Axor Helmets are renowned for their exceptional quality and innovative design. Crafted with advanced materials and cutting-edge technology, these helmets offer superior protection and comfort for riders. From sleek and aerodynamic full-face helmets to stylish open-face designs, Axor Helmets cater to a wide range of preferences and riding styles. Featuring features like high-impact ABS shells, multi-density EPS liners, and adjustable ventilation systems, Axor Helmets ensure optimal safety and airflow during every ride. With certifications from regulatory bodies like DOT and ECE, riders can trust Axor Helmets to deliver top-notch protection on the road. Whether you're commuting in the city or exploring the open highway, Axor Helmets are the perfect choice for riders who prioritize safety, style, and performance.</p>
          <h2>Price: Rs.19,000</h2>
          <h3>Quality: High quality material</h3>
          <h3>Manufacture Process: Advanced manufacturing techniques</h3>
          <h3>Specifications:</h3>
          <ul>
            <li><strong>Brand:</strong> AXOR</li>
            <li><strong>SKU:</strong> 170200954_LK-1119857546</li>
            ...
            <li><strong>Quality Certification:</strong> DOT5</li>
          </ul>
