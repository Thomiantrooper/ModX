    ...
    <div className="product-container">
      <div className="helmets-container">
        <div className="helmet-item" onClick={() => handleSelectHelmet(1)}>
          <img src="/images/bunny4.jpeg" alt="Helmet 1" className={selectedHelmet === 1 ? 'selected' : ''} />
        </div>
        <div className="helmet-item" onClick={() => handleSelectHelmet(2)}>
          <img src="/images/bunny3.jpeg" alt="Helmet 2" className={selectedHelmet === 2 ? 'selected' : ''} />
        </div>
        <div className="helmet-item" onClick={() => handleSelectHelmet(3)}>
          <img src="/images/bunny.jpg" alt="Helmet 3" className={selectedHelmet === 3 ? 'selected' : ''} />
        </div>
      </div>
      <div className="description-container">
        <div className="description-content">
          <h2>Details:</h2>
          <p>Description: The Vega Bolt Bunny Full Face Helmet combines strength and style to deliver an exceptional riding experience. Crafted with a high-impact ABS material shell, it offers robust protection while boasting an aerodynamic design for a smooth ride. With certifications from DOT and ISI, this helmet ensures top-notch safety standards. Its convenient metallic quick-release silent buckle allows easy fastening, while the removable, washable lining keeps things fresh. The scratch-resistant, UV-protected visor ensures clear vision, complemented by a well-designed ventilation system for comfort throughout your journey.</p>
          <h2>Price: Rs.18,000</h2>
          <h3>Quality: High quality material</h3>
          <h3>Manufacture Process: Advanced manufacturing techniques</h3>
          <h3>Specifications:</h3>
          <ul>
            <li><strong>Brand:</strong> No Brand</li>
            <li><strong>SKU:</strong> 170200954_LK-1119067180</li>
